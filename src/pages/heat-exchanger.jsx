...
import { DEFAULT_FORM_VALUES, HEAT_EXCHANGER_TYPES, MATERIALS, ANIMATION_CONFIG, UI_CONFIG } from '@/constants/formConfig';
        ...
        <div className="backdrop-blur-3xl bg-white/20 border border-white/40 shadow-2xl rounded-3xl overflow-hidden">
          ...
          <div className="p-8 text-center backdrop-blur-md bg-white/10">
            ...
            <div className="space-y-3">
              ...
              <Button onClick={handleReset} className="w-full bg-gradient-to-r from-blue-500/90 to-purple-600/90 hover:from-blue-600/90 hover:to-purple-700/90 text-white font-semibold py-4 rounded-2xl transition-all duration-300 transform hover:scale-105 shadow-xl border border-white/30 backdrop-blur-md">
